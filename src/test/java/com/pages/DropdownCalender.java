...
public class DropdownCalender {
    ...
    public static By DOB1=By.id("dateOfBirthInput");
    ...
    public static By day=By.xpath("//div[@class='react-datepicker__month']/div/div");
    public static By subject=By.xpath("//div[@id='subjectsContainer']/div");
    public static By autoOp=By.xpath("//div[@id='subjectsContainer']/div/div");
